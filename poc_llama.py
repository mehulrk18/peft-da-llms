...
import os
import torch
from transformers import BitsAndBytesConfig, AutoModelForCausalLM, AutoModelForSeq2SeqLM, set_seed, AutoTokenizer, \
    TrainingArguments, Seq2SeqTrainingArguments, Seq2SeqTrainer, Trainer, TrainerCallback, DataCollatorForSeq2Seq
import bitsandbytes
...
# Model Config
llama3_model_id = "meta-llama/Meta-Llama-3-8B-Instruct" # "meta-llama/Meta-Llama-3.1-8B-Instruct"
...
if not full_finetune and add_bnb_config:
